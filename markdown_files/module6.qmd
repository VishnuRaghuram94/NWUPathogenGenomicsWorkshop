...
![Parts of a phylogeny ([T. Ryan Gregory, 2008](https://evolution-outreach.biomedcentral.com/articles/10.1007/s12052-008-0035-x)).](https://media.springernature.com/full/springer-static/image/art%3A10.1007%2Fs12052-008-0035-x/MediaObjects/12052_2008_35_Fig2_HTML.gif?as=webp)
...
![Example of important clinical and public health questions (top row) were tackled using phylogenomic methods (middle row), leading to actionable public health and clinical insights during the COVID-19 pandemic (bottom row; [Attwood, et al.](https://www.nature.com/articles/s41576-022-00483-8)).](https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fs41576-022-00483-8/MediaObjects/41576_2022_483_Fig1_HTML.png)
...
-  Use SNP-sites to calculate the number of constant sites (A, C, G, and T) in our clean genomic alignment, `clean_core.full.aln`:

    ```bash
    snp-sites -C clean_core.full.aln > fconst.csv
    ```
    
    - `snp-sites` : Call SNP-sites
    - `-C` : Flag to output only counts of constant sites in our alignment (A, C, G, and T)
    - `clean_core.full.aln` : Provide the path to our input multi-FASTA alignment (i.e., our full, clean genomic alignment produced via `Snippy`)
...
-  Use IQ-TREE to construct a ML phylogeny
    ...
    ```bash
    iqtree -s gubbins_clean_core.aln -m MFP -B 1000 -T 1 -fconst $(cat fconst.csv)
    ```

    - `iqtree` : Call IQ-TREE
    - `gubbins_clean_core.aln` : Provide the path to our input multi-FASTA alignment (i.e., our final, recombination-free core SNP alignment; )
...
![Core genome vs Pan-genome: Some genes are present in all (or most) members whereas some genes are only present in a few members](assets/images/module6/core_v_pan.png)
...
![Higher proportion of reads will align to the pangenome reference [Matthews et al.](https://pmc.ncbi.nlm.nih.gov/articles/PMC11570541/)](/assets/images/module6/matthews_et_al.jpeg)

#### Pangenome estimation

##### Gene presence/absence pangenome:
Pangenome tools accept genome annotations in `.gff` format as input, cluster the annotated sequences at different thresholds into gene families, and then calculate the presence/absence of gene families across the population. There are several pangenome pipelines currently available ([PanX](https://github.com/neherlab/pan-genome-analysis), [PIRATE](https://github.com/SionBayliss/PIRATE), [Panaroo](https://gthlab.au/panaroo/#/), [Roary](https://sanger-pathogens.github.io/Roary/) and more) and they all work similarly. The different tools usually differ in exactly how the annotations are clustered into gene families.

![Gene presence absence across a diverse population](assets/images/module6/pangenome_presabs.png)

##### Pangenome graphs: 

A pangenome graph comprises entire sequence regions (not just coding sequences/genes) and represents an alignment of multiple regions. The graph models the orientation of these sequence regions with potential alternate paths (sometimes called 'bubbles') to display variation. The pangenome graph is a more complex datastructure than binary gene presence/absence matrices, however they preserve gene synteny information as well as intergenic variation. Sequence based pangenome graphs can be constructed using tools like [Minigraph-cactus](https://github.com/ComparativeGenomicsToolkit/cactus) and [PanGenome Graph Builder (PGGB)](https://github.com/pangenome/pggb).

![Pangenome graph: [Eizenga et al., 2021](https://pmc.ncbi.nlm.nih.gov/articles/PMC8006571/)](assets/images/module6/pangenome_graph.png)
...
-   Attwood SW, et al., [Phylogenetic and phylodynamic approaches to understanding and combating the early SARS-CoV-2 pandemic](https://pubmed.ncbi.nlm.nih.gov/35459859/). *Nat Rev Genet*. 2022 Sep;23(9):547-562. doi: 10.1038/s41576-022-00483-8. Epub 2022 Apr 22. PMID: 35459859; PMCID: PMC9028907.
-   Eizenga JM, et al., [Pangenome Graphs](https://pmc.ncbi.nlm.nih.gov/articles/PMC8006571/). *Annu Rev Genomics Hum Genet*. 2020 Aug 31;21:139-162. doi: 10.1146/annurev-genom-120219-080406. Epub 2020 May 26. PMID: 32453966; PMCID: PMC8006571.
-   Gregory, T.R.,[Understanding Evolutionary Trees](https://evolution-outreach.biomedcentral.com/articles/10.1007/s12052-008-0035-x). *Evo Edu Outreach* 1, 121–137 (2008). https://doi.org/10.1007/s12052-008-0035-x
-   Matthews CA, et al. [A gentle introduction to pangenomics](https://pmc.ncbi.nlm.nih.gov/articles/PMC11570541/). *Brief Bioinform*. 2024 Sep 23;25(6):bbae588. doi: 10.1093/bib/bbae588. PMID: 39552065; PMCID: PMC11570541.
-   Yang Z, Rannala B. [Molecular phylogenetics: principles and practice](https://pubmed.ncbi.nlm.nih.gov/22456349/). *Nat Rev Genet*. 2012 Mar 28;13(5):303-14. doi: 10.1038/nrg3186. PMID: 22456349.
