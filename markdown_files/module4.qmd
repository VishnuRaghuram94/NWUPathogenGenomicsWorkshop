...
-   `gubbins.filtered_polymorphic_sites.fasta`: Path to the recombination-free alignment of SNPs produced via `gubbins` as input
...
-   `> gubbins_clean_core_aln.snp-dists.tsv`: Write our SNP distances output to a file called `gubbins_clean_core_aln.snp-dists.tsv`
...
-   Katz LS, et al., [Mashtree: a rapid comparison of whole genome sequence files](https://pmc.ncbi.nlm.nih.gov/articles/PMC9380445/). *J Open Source Softw*. 2019 Dec 10;4(44):10.21105/joss.01762. doi: 10.21105/joss.01762. PMID: 35978566; PMCID: PMC9380445.
